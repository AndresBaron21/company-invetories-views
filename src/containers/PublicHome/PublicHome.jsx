        ...
        return (
            <div className="introduction-text">
                    ...
                    <div className="criterion">
                        <div className="text text0">LITE </div>
                        <div className="text text1">T</div>
                        <div className="text text2">H</div>
                        <div className="text text3">I</div>
                        <div className="text text4">N</div>
                        <div className="text text5">K</div>
                        <div className="text text6">I</div>
                        <div className="text text7">N</div>
                        <div className="text text8">G</div>
